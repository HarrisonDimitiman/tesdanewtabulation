                    ...
                    <div class="card">
                        ...
                        <h4>
                            <i class="fa fa-align-justify"></i>
                             {{ __('Knapsack Sprayer Calibration Management') }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                @foreach($getKnapsackCrits as $getKnapsackCrits)
                                        <tr>
                                            <td>{{ $loop->iteration ?? '' }}</td>
                                            <td>{{ $getKnapsackCrits->crit_name ?? '' }}</td>
                                            <td>{{ $getKnapsackCrits->crit_percentage ?? '' }}</td>
                                            <td style="width: 9%;">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a type="button" class="dropdown-item btn" href="{{ URL::to('/guidelinesKnapsack/'.$getKnapsackCrits->id) }}">
