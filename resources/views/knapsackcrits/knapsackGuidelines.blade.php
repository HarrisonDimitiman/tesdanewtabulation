...
@section('content')
@include('knapsackcrits._createGuideline')


<div class="container-fluid">
    <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb">
         <a href="{{ URL::to('/knapsackcrits') }}">
          <li class="breadcrumb-item" aria-current="page">Criteria Knapsack Sprayer Calibration</li>
         </a>
         &nbsp;/&nbsp;
          <li class="breadcrumb-item active " aria-current="page">Guideline Knapsack Sprayer Calibration</li>
        </ol>
      </nav>
        <div class="fadeIn">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                    @foreach($getKnapsackGuidlines as $getKnapsackGuidlines)
                                        <tr>
                                            <td>{{ $loop->iteration ?? '' }}</td>
                                            <td>{{ $getKnapsackGuidlines->gd_name ?? '' }}</td>
                                            <td>{{ $getKnapsackGuidlines->gd_total ?? '' }}</td>
                                            <td style="width: 9%;">
                                                <div class="btn-group">
