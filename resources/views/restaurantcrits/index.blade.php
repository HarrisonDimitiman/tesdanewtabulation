...
@section('content')
@include('restaurantcrits._create')
                    ...
                    <div class="card">
                        ...
                        <h4>
                            <i class="fa fa-align-justify"></i>
                             {{ __('Restaurant Services Management') }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                @foreach($getRestaurantCrits as $getRestaurantCrits)
                                        <tr>
                                            <td>{{ $loop->iteration ?? '' }}</td>
                                            <td>{{ $getRestaurantCrits->crit_name ?? '' }}</td>
                                            <td>{{ $getRestaurantCrits->crit_percentage ?? '' }}</td>
                                            <td style="width: 9%;">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a type="button" class="dropdown-item btn" href="{{ URL::to('/guidelinesRestaurant/'.$getRestaurantCrits->id) }}">
