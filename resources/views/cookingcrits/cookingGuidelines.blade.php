...
@section('content')
@include('cookingcrits._createGuideline')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                    @foreach($getCookingGuidlines as $getCookingGuidlines)
                                        <tr>
                                            <td>{{ $loop->iteration ?? '' }}</td>
                                            <td>{{ $getCookingGuidlines->gd_name ?? '' }}</td>
                                            <td>{{ $getCookingGuidlines->gd_total ?? '' }}</td>
                                            <td style="width: 9%;">
                                                <div class="btn-group">
