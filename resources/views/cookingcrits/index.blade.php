                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                @foreach($getCookingCrits as $getCookingCrits)
                                        <tr>
                                            <td>{{ $loop->iteration ?? '' }}</td>
                                            <td>{{ $getCookingCrits->crit_name ?? '' }}</td>
                                            <td>{{ $getCookingCrits->crit_percentage ?? '' }}</td>
                                            <td style="width: 9%;">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a type="button" class="dropdown-item btn" href="{{ URL::to('/guidelinesCooking/'.$getCookingCrits->id) }}">
