...
@section('content')
@include('feedcrits._createGuideline')
                    ...
                    <div class="card">
                        ...
                        <h4>
                            <i class="fa fa-align-justify"></i>
                             {{ __('Feed Formulation and Mixing Guidelines Management for') }} {{ $getFeedCrit->crit_name }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                    @foreach($getFeedGuidlines as $getFeedGuidlines)
                                        <tr>
                                            <td>{{ $loop->iteration ?? '' }}</td>
                                            <td>{{ $getFeedGuidlines->gd_name ?? '' }}</td>
                                            <td>{{ $getFeedGuidlines->gd_total ?? '' }}</td>
                                            <td style="width: 9%;">
                                                <div class="btn-group">
